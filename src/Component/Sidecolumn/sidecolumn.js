  ...
  return (
    <div className={sideStyle['sidebar']}>
      <div
        ...
        onMouseEnter={() => {
          markerpos.current.style.display = 'block';
        }}
        onMouseLeave={() => {
          markerpos.current.style.display = 'none';
        }}
      >
        <ul className={sideStyle['sidebar_optionbar_options']}>
          <li
            onClick={() => {
              setPanelMode({ ...panelMode, panel: 0 });
            }}
            className={panelMode.panel === 0 ? sideStyle['active'] : ''}
          ...
          <li
            onClick={() => {
              setPanelMode({ ...panelMode, panel: 1 });
            }}
            className={panelMode.panel === 1 ? sideStyle['active'] : ''}
            onMouseEnter={updateMarkerPos}
          >
            <a>
